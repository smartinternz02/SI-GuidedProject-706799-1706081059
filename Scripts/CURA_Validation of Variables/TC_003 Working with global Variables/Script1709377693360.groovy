...
// defina and initialize variable withput data type
...
String actual_title = WebUI.getText(findTestObject('Page_CURA Healthcare Service/h2_Make Appointment'))

//landingPage = WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/div_Appointment Confirmation               _7d61e7'), 
