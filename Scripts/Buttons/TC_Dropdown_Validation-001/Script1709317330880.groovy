...
WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/label_Facility'), 0)
...
WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/label_Visit Date (Required)'), 'Visit Date (Required)')
