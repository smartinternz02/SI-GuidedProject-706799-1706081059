...
unchecked = WebUI.verifyElementNotChecked(findTestObject('Page_CURA Healthcare Service/label_Medicaid'), 0)

if (unchecked == true) {
    System.out.println('element not checkeck')

    WebUI.check(findTestObject('Page_CURA Healthcare Service/label_Medicaid'))
...
WebUI.uncheck(findTestObject('Page_CURA Healthcare Service/label_Medicaid'), FailureHandling.STOP_ON_FAILURE)
